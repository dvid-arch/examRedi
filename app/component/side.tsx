...
function Side() {
    ...
    return (
        <aside className='hidden px-4 pt-4 pb-8  h-screen  md:flex md:flex-col '>
            <div className='flex-1 flex  flex-col justify-between overflow-auto'>
                <div className='fixed top-4 bg-white left-0 right-0 px-8 py-4'>
                    <Logo />
                </div>
                <div className='mt-10 flex-1  flex flex-col justify-between'>

                    <nav className='py-10 flex-1 '>
